    ...
    public partial class inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 6, 2, 21, 9, 21, 535, DateTimeKind.Local).AddTicks(6474), "Computer", 800m, 35m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 2, 2, new DateTime(2023, 6, 2, 21, 9, 21, 535, DateTimeKind.Local).AddTicks(6482), "T-Shirt", 50m, 400m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 3, 3, new DateTime(2023, 6, 2, 21, 9, 21, 535, DateTimeKind.Local).AddTicks(6483), "Cat Food", 25m, 1000m, null });
