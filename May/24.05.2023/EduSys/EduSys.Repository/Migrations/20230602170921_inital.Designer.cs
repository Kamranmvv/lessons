...
namespace EduSys.Repository.Migrations
{
    ...
    [Migration("20230602170921_inital")]
            ...
            modelBuilder.Entity("EduSys.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 6, 2, 21, 9, 21, 535, DateTimeKind.Local).AddTicks(6474),
                            Name = "Computer",
                            Price = 800m,
                            Stock = 35m
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 6, 2, 21, 9, 21, 535, DateTimeKind.Local).AddTicks(6482),
                            Name = "T-Shirt",
                            Price = 50m,
                            Stock = 400m
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2023, 6, 2, 21, 9, 21, 535, DateTimeKind.Local).AddTicks(6483),
                            Name = "Cat Food",
                            Price = 25m,
                            Stock = 1000m
                        });
